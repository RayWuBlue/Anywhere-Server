    ...
    <table width="95%" border="0" align="center" cellpadding="0" cellspacing="1" bgcolor="#666666">
      <tr>
        <td height="30" background="Public/admin/images/bg_list.gif">
          <div  style="padding-left:10px; font-weight:bage; color:#FFFFFF">社区板块管理</div>
        </td>
      </tr>
      <tr>
        <td bgcolor="#FFFFFF">
              ...
              <tr>
                <td colspan="3" >
                  <table width="100%" border="0" cellpadding="5" cellspacing="0">
                    ...
                    <?php if(is_array($forum_comment)): $i = 0; $__LIST__ = $forum_comment;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                        <td width="5%" class="td">
          ...
          window.location.href='/app/admin.php?s=/BBS/delete_reply/id/'+<?php echo ($vo["id"]); ?>+'/info_id/'+<?php echo ($vo["info_id"]); ?>;}else{history.go(0);}" />
                        </td>
                      </tr>
                      <tr>
                        <td class="td" height="60">&nbsp;</td>
                        <td class="td">内容：</td>
                        <td class="td" colspan="4"><?php echo ($vo["reply_content"]); ?></td>
