...
<table width="664" border="0" align="center" cellpadding="0" cellspacing="0">
  ...
  <tr>
    <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
            <tr>
              <td width="250" height="50" align="left" valign="middle"><img src="Public/admin/images/logo.gif" width="246" height="49" /></td>
                      ...
                      <td colspan="2" align="left" valign="middle"><table width="100%" border="0" cellspacing="0" cellpadding="10">
                          <tr>
                            ...
                            <td height="35" colspan="2" align="left" valign="middle">
								<input name="ttedu_musers" type="text" class="input" id="name" size="25" maxlength="20" /></td>
                          </tr>
                          <tr>
                            <td height="35" align="center" valign="middle" class="t2">密&nbsp;&nbsp;码：</td>
                            <td height="35" colspan="2" align="left" valign="middle">
								<input name="ttedu_mpassword" type="password" class="input" id="pass" size="27" maxlength="20" /></td>
                          </tr>
                          <!--
						  <tr>
