...
<A href="__APP__/InfoDetail/infolist/ttedu_id/<?php echo ($btype_info["ttedu_id"]); ?>"><?php echo ($btype_info["ttedu_btype_name"]); ?></A> &gt; 
<STRONG><?php echo ($info_detail["ttedu_title"]); ?></STRONG></P></DIV>
<DIV class=tit01>
...
<DIV class=tit01>
<DIV class=zxtit01T3><IMG src="Public/images/d10.gif"> 
<H2>相关文章</H2></DIV>
...
<DIV class=hackbox></DIV></DIV></DIV></DIV><!--中部左区结束，右区开始-->
<DIV class=PrightM>
<DIV class=tit01>
<DIV>
<DIV class=tit01>
