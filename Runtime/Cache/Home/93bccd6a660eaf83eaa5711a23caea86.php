...
<DIV class=PleftM>
<DIV class=rcur>
<P><STRONG>当前位置：</STRONG><A href="__APP__/index/index">首页</A>&gt; 
	...
	<TABLE border=0 cellSpacing=0 cellPadding=0 width="650" align=center>
      ...
      <TABLE class=BGWhite border=0 cellSpacing=1 cellPadding=0 width="650" align=center>
		...
		<?php if(is_array($spinfo_detail)): $i = 0; $__LIST__ = $spinfo_detail;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): ++$i;$mod = ($i % 4 )?><?php if(($mod)  ==  "1"): ?><TR class=BGBlue10 height=180><?php endif; ?>
          <TD align=middle><A 
            href="__URL__/videodetail/ttedu_id/<?php echo ($vo["ttedu_id"]); ?>/jishu/0" 
            target=_blank><IMG border=0 alt="<?php echo ($vo["ttedu_sptitle"]); ?>[<?php echo ($vo["ttedu_spjishu"]); ?>集]" 
            src="__PUBLIC__/Uploads/<?php echo ($vo["ttedu_sppic"]); ?>" width="126" height="94"></A><BR><A 
            href="__URL__/videodetail/ttedu_id/<?php echo ($vo["ttedu_id"]); ?>" 
            target=_blank><FONT 
          color=#006600><?php echo ($vo["ttedu_sptitle"]); ?><BR>[<?php echo ($vo["ttedu_spjishu"]); ?>集]</FONT></A></TD>
